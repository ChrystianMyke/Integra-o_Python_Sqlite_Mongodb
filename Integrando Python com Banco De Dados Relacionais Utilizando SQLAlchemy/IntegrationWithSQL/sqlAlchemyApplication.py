"""
    Primeiro programa de integração com banco de dados utilizando SQLAlchemy e modelo ORM
"""
...
#   criando as classe como tabelas no bancos de dados
Base.metadata.create_all(engine)

#   depreciando - será removido em futuro release
# print(engine.tabela_names())
...
with Session(engine) as session:
    ...
    sandy = User(
        ...
        address=[Address(email_address='sandy@gmail.com.br'),
                 Address(email_address='sandyc@email.com')]
    )
